import { a as T, b as y, c as p, d as A, e as h, g as m } from "@nf-internal/chunk-LOHFO5VT";
import { a as M, d as f } from "@nf-internal/chunk-4CLCTAJ7";
import { \u0275DomAdapter as F, \u0275setRootDomAdapter as P, \u0275parseCookieValue as B, \u0275getDOM as w, DOCUMENT as O, \u0275PLATFORM_BROWSER_ID as N, XhrFactory as V, CommonModule as x } from "@angular/common";
import * as s from "@angular/core";
import { \u0275global as u, \u0275RuntimeError as U, \u0275internalCreateApplication as S, \u0275resolveComponentResources as ce, PLATFORM_ID as j, PLATFORM_INITIALIZER as K, createPlatformFactory as H, platformCore as J, InjectionToken as de, \u0275TESTABILITY_GETTER as W, \u0275TESTABILITY as G, Testability as E, \u0275INJECTOR_SCOPE as Y, ErrorHandler as _, RendererFactory2 as z, ApplicationModule as X, \u0275setDocument as Z } from "@angular/core";
...
function Ee(t, n, e) { return f(this, null, function* () { let r = M({ rootComponent: t }, b(n, e)); return S(r); }); }
function Re(t, n) { return f(this, null, function* () { return S(b(t, n)); }); }
...
function oe() { return new _; }
function ie() { return Z(document), document; }
var C = [{ provide: j, useValue: N }, { provide: K, useValue: re, multi: !0 }, { provide: O, useFactory: ie }], ge = H(J, "browser", C);
var L = [{ provide: W, useClass: v }, { provide: G, useClass: E }, { provide: E, useClass: E }], k = [{ provide: Y, useValue: "root" }, { provide: _, useFactory: oe }, { provide: p, useClass: y, multi: !0 }, { provide: p, useClass: ne, multi: !0 }, m, h, A, { provide: z, useExisting: m }, { provide: V, useClass: $ }, []], De = (() => { class t {
    constructor() { }
    static \u0275fac = function (r) { return new (r || t); };
    static \u0275mod = s.\u0275\u0275defineNgModule({ type: t });
    static \u0275inj = s.\u0275\u0275defineInjector({ providers: [...k, ...L], imports: [x, X] });
} return t; })();
