import { $c as v, Kc as f, Mc as b, S as l, d, hd as w, jd as x, kd as g, md as h, nd as j, pd as M, rd as k } from "@nf-internal/chunk-GSMICYHT";
import "@nf-internal/chunk-SLWIJEXV";
import "@nf-internal/chunk-YEU6INBQ";
...
function B(t) { return M(D(y({}, t), { loader: void 0, stream: e => { let n, r = () => n?.unsubscribe(); e.abortSignal.addEventListener("abort", r); let u = v({ value: void 0 }), o, i = new Promise(a => o = a); function c(a) { u.set(a), o?.(u), o = void 0; } let s = t.stream ?? t.loader; if (s === void 0)
