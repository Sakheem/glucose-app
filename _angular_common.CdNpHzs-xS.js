import { a as Ot, b as Pt, c as Bt, d as U, e as Nt, f as kt, g as xt, h as $t } from "@nf-internal/chunk-674MHT74";
import { d as xe } from "@nf-internal/chunk-K7B64FOA";
import { a as Y, b as K } from "@nf-internal/chunk-4CLCTAJ7";
import * as _ from "@angular/core";
import { InjectionToken as Ut, inject as je, DOCUMENT as jt, \u0275\u0275inject as zt } from "@angular/core";
...
var B = (() => { class e {
    ...
    static \u0275prov = _.\u0275\u0275defineInjectable({ token: e, factory: () => je(J), providedIn: "root" });
} return e; })(), q = new Ut(""), J = (() => { class e extends B {
    _platformLocation;
    _baseHref;
    _removeListenerFns = [];
    constructor(t, n) { super(), this._platformLocation = t, this._baseHref = n ?? this._platformLocation.getBaseHrefFromDOM() ?? je(jt).location?.origin ?? ""; }
...
var De = (() => { class e {
    ...
    constructor(t) { this._locationStrategy = t; let n = this._locationStrategy.getBaseHref(); this._basePath = Zt($e(Ue(n))), this._locationStrategy.onPopState(r => { this._subject.next({ url: this.path(!0), pop: !0, state: r.state, type: r.type }); }); }
    ...
    normalize(t) { return e.stripTrailingSlash(Wt(this._basePath, Ue(t))); }
...
function Gt() { return new De(zt(B)); }
...
function et(e) { return y(e)[f.LocaleId]; }
function tt(e, i, t) { let n = y(e), r = [n[f.DayPeriodsFormat], n[f.DayPeriodsStandalone]], s = I(r, i); return I(s, t); }
function nt(e, i, t) { let n = y(e), r = [n[f.DaysFormat], n[f.DaysStandalone]], s = I(r, i); return I(s, t); }
function it(e, i, t) { let n = y(e), r = [n[f.MonthsFormat], n[f.MonthsStandalone]], s = I(r, i); return I(s, t); }
function rt(e, i) { let n = y(e)[f.Eras]; return I(n, i); }
...
var st = Yt;
function ot(e) { if (!e[f.ExtraData])
    throw new v(2303, !1); }
function at(e) { let i = y(e); return ot(i), (i[f.ExtraData][2] || []).map(n => typeof n == "string" ? pe(n) : [pe(n[0]), pe(n[1])]); }
function ut(e, i, t) { let n = y(e); ot(n); let r = [n[f.ExtraData][0], n[f.ExtraData][1]], s = I(r, i) || []; return I(s, t) || []; }
...
function ct(e, i, t = "en") { let n = ln(t)[e] || Je[e] || [], r = n[1]; return i === "narrow" && typeof r == "string" ? r : n[0] || e; }
var hn = 2;
function dt(e) { let i, t = Je[e]; return t && (i = t[2]), typeof i == "number" ? i : hn; }
...
function lt(e, i, t, n) { let r = Sn(e); i = T(t, i) || i; let o = [], u; for (; i;)
    if (u = Dn.exec(i), u) {
        ...
        o.push(i);
        break;
    } let D = r.getTimezoneOffset(); n && (D = ht(n, D), r = An(r, n)); let h = ""; return o.forEach(g => { let c = En(g); h += c ? c(r, t, D) : g === "''" ? "'" : g.replace(/(^'|'$)/g, "").replace(/''/g, "'"); }), h; }
...
function Cn(e, i, t, n, r, s) { switch (t) {
    ...
    case 0:
        ...
        if (s) {
            let h = at(i), g = ut(i, r, n), c = h.findIndex(F => { if (Array.isArray(F)) {
...
function me(e, i = !1) { return function (t, n) { let r; if (i) {
    ...
    let s = ft(t), o = Fn(s.getFullYear()), u = s.getTime() - o.getTime();
    r = 1 + Math.round(u / 6048e5);
} return M(r, e, b(n, m.MinusSign)); }; }
function ne(e, i = !1) { return function (t, n) { let s = ft(t).getFullYear(); return M(s, e, b(n, m.MinusSign), i); }; }
var Ce = {};
...
function An(e, i, t) { let r = e.getTimezoneOffset(), s = ht(i, r); return wn(e, -1 * (s - r)); }
function Sn(e) { if (He(e))
...
var bn = /^(\d+)?\.((\d+)(-(\d+))?)?$/, Ge = 22, se = ".", H = "0", vn = ";", In = ",", ye = "#", We = "\xA4", Ln = "%";
...
function gt(e, i, t, n, r) { let s = ue(i, W.Currency), o = be(s, b(i, m.MinusSign)); return o.minFrac = dt(n), o.maxFrac = o.minFrac, _e(e, o, i, m.CurrencyGroup, m.CurrencyDecimal, r).replace(We, t).replace(We, "").trim(); }
function Dt(e, i, t) { let n = ue(i, W.Percent), r = be(n, b(i, m.MinusSign)); return _e(e, r, i, m.Group, m.Decimal, t, !0).replace(new RegExp(Ln, "g"), b(i, m.PercentSign)); }
function pt(e, i, t) { let n = ue(i, W.Decimal), r = be(n, b(i, m.MinusSign)); return _e(e, r, i, m.Group, m.Decimal, t); }
...
} return r > Ge && (n = n.splice(0, Ge - 1), t = r - 1, r = 1), { digits: n, exponent: t, integerLen: r }; }
...
var ce = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = a.\u0275\u0275defineInjectable({ token: e, factory: () => new Ct(Se(x)), providedIn: "root" });
} return e; })();
...
var Ct = (() => { class e extends ce {
    ...
    set klass(t) { this.initialClasses = t != null ? t.trim().split(Ee) : Ze; }
...
function Ie(e, i) { if (typeof i != "string")
    throw R(e, i); }
var Kn = "mediumDate", Et = new qe(""), wt = new qe(""), Xn = (() => { class e {
    locale;
    defaultTimezone;
    defaultOptions;
    ...
    transform(t, n, r) { if (t == null)
        ...
        throw R(e, n); let s = mt(t, Object.keys(n), this._localization, r); return n[s].replace(qn, t.toString()); }
...
import { inject as L, DestroyRef as It, \u0275registerLocaleData as di, Version as li, \u0275\u0275defineInjectable as fi, DOCUMENT as Lt, \u0275formatRuntimeError as hi, InjectionToken as Oe, \u0275RuntimeError as Pe, \u0275IMAGE_CONFIG as gi, Renderer2 as Di, ElementRef as pi, Injector as mi, \u0275performanceMarkFeature as Ci, booleanAttribute as de, numberAttribute as _t, ChangeDetectorRef as yi, \u0275IMAGE_CONFIG_DEFAULTS as Fi, \u0275unwrapSafeValue as Ei } from "@angular/core";
import { DOCUMENT as Vr, \u0275IMAGE_CONFIG as Hr } from "@angular/core";
import * as At from "@angular/core";
import { InjectionToken as ui } from "@angular/core";
var ci = new ui("", { factory: () => typeof window < "u" && typeof window.NavigationPrecommitController < "u" }), St = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = At.\u0275\u0275defineInjectable({ token: e, factory: () => window.navigation, providedIn: "platform" });
} return e; })();
var _r = (() => { class e extends De {
    navigation = L(St);
    destroyRef = L(It);
...
function vr(e) { return e === wi; }
function Ir(e) { return e === Ai; }
var Lr = new li("21.2.10"), Mr = (() => { class e {
    static \u0275prov = fi({ token: e, providedIn: "root", factory: () => typeof ngServerMode < "u" && ngServerMode ? new Re : new Te(L(Lt), window) });
} return e; })(), Te = class {
    document;
    window;
    offset = () => [0, 0];
...
var Rt = e => e.src, Be = new Oe("", { factory: () => Rt });
function fe(e, i) { return function (n) { return Tt(n) || vi(n, i || []), n = _i(n), [{ provide: Be, useValue: o => (Mt(o.src) && Ii(n, o.src), e(n, K(Y({}, o), { src: bi(o.src) }))) }]; }; }
...
function Oi(e, i) { let t = new URL(i ?? "https://a/"); t.pathname = "/.netlify/images", !Mt(e.src) && !e.src.startsWith("/") && (e.src = "/" + e.src), t.searchParams.set("url", e.src), e.width && t.searchParams.set("w", e.width.toString()), e.height && t.searchParams.set("h", e.height.toString()); let n = e.loaderParams?.quality ?? e.loaderParams?.q; e.isPlaceholder && !n && t.searchParams.set("q", le); for (let [r, s] of Object.entries(e.loaderParams ?? {}))
...
var kr = (() => { class e {
    ...
    shouldGenerateAutomaticSrcset() { let t = !1; return this.sizes || (t = this.width > xi || this.height > $i), !this.disableOptimizedSrcset && !this.srcset && this.imageLoader !== Rt && !t; }
...
export { q as APP_BASE_HREF, Hn as AsyncPipe, kt as BrowserPlatformLocation, ai as CommonModule, si as CurrencyPipe, wt as DATE_PIPE_DEFAULT_OPTIONS, Et as DATE_PIPE_DEFAULT_TIMEZONE, Vr as DOCUMENT, Xn as DatePipe, ii as DecimalPipe, E as FormStyle, A as FormatWidth, sn as HashLocationStrategy, Jn as I18nPluralPipe, Qn as I18nSelectPipe, Hr as IMAGE_CONFIG, Be as IMAGE_LOADER, ei as JsonPipe, ni as KeyValuePipe, Nt as LOCATION_INITIALIZED, De as Location, B as LocationStrategy, Gn as LowerCasePipe, On as NgClass, Pn as NgComponentOutlet, yt as NgFor, yt as NgForOf, oe as NgForOfContext, Nn as NgIf, ae as NgIfContext, Ct as NgLocaleLocalization, ce as NgLocalization, kr as NgOptimizedImage, Ft as NgPlural, $n as NgPluralCase, Un as NgStyle, ve as NgSwitch, kn as NgSwitchCase, xn as NgSwitchDefault, jn as NgTemplateOutlet, Vt as NoTrailingSlashPathLocationStrategy, W as NumberFormatStyle, m as NumberSymbol, Nr as PRECONNECT_CHECK_BLOCKLIST, J as PathLocationStrategy, ri as PercentPipe, U as PlatformLocation, St as PlatformNavigation, N as Plural, oi as SlicePipe, Zn as TitleCasePipe, Ht as TrailingSlashPathLocationStrategy, d as TranslationWidth, Yn as UpperCasePipe, Lr as VERSION, Mr as ViewportScroller, Qe as WeekDay, $t as XhrFactory, gt as formatCurrency, lt as formatDate, pt as formatNumber, Dt as formatPercent, ct as getCurrencySymbol, dn as getLocaleCurrencyCode, cn as getLocaleCurrencyName, un as getLocaleCurrencySymbol, j as getLocaleDateFormat, V as getLocaleDateTimeFormat, nt as getLocaleDayNames, tt as getLocaleDayPeriods, fn as getLocaleDirection, rt as getLocaleEraNames, at as getLocaleExtraDayPeriodRules, ut as getLocaleExtraDayPeriods, on as getLocaleFirstDayOfWeek, et as getLocaleId, it as getLocaleMonthNames, ue as getLocaleNumberFormat, b as getLocaleNumberSymbol, st as getLocalePluralCase, z as getLocaleTimeFormat, an as getLocaleWeekEndRange, dt as getNumberOfCurrencyDigits, vr as isPlatformBrowser, Ir as isPlatformServer, Tr as provideCloudflareLoader, Rr as provideCloudinaryLoader, Or as provideImageKitLoader, Pr as provideImgixLoader, Br as provideNetlifyLoader, br as registerLocaleData, Bt as \u0275DomAdapter, _r as \u0275NavigationAdapterForLocation, Re as \u0275NullViewportScroller, wi as \u0275PLATFORM_BROWSER_ID, Ai as \u0275PLATFORM_SERVER_ID, ci as \u0275PRECOMMIT_HANDLER_SUPPORTED, Ot as \u0275getDOM, S as \u0275normalizeQueryParams, xt as \u0275parseCookieValue, Pt as \u0275setRootDomAdapter };
