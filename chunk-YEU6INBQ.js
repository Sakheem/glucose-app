...
var o = null, v = !1, M = 1, h = null, S = Symbol("SIGNAL");
...
function F() { M++; }
function p(e) { if (!(m(e) && !e.dirty) && !(!e.dirty && e.lastCleanEpoch === M)) {
...
function k() { return o?.consumerAllowSignalWrites !== !1; }
function U(e) { e.dirty = !0, L(e), e.consumerMarkedDirty?.(e); }
function C(e) { e.dirty = !1, e.lastCleanEpoch = M; }
...
function b(e, r) { let n = e.consumersTail, u = m(e); if (n !== void 0 ? (r.nextConsumer = n.nextConsumer, n.nextConsumer = r) : (r.nextConsumer = void 0, e.consumers = r), r.prevConsumer = n, e.consumersTail = r, !u)
    for (let t = e.producers; t !== void 0; t = t.nextProducer)
        b(t.producer, t); }
function A(e) { let r = e.producer, n = e.nextProducer, u = e.nextConsumer, t = e.prevConsumer; if (e.nextConsumer = void 0, e.prevConsumer = void 0, u !== void 0 ? u.prevConsumer = t : r.consumersTail = t, t !== void 0)
    t.nextConsumer = u;
...
function R(e, r) { k() || O(e), e.equal(e.value, r) || (e.value = r, z(e)); }
function x(e, r) { k() || O(e), R(e, r(e.value)); }
function ue(e) { y?.(e); }
...
export { S as a, g as b, H as c, J as d, Q as e, E as f, N as g, F as h, p as i, L as j, k, U as l, C as m, T as n, G as o, w as p, q, V as r, X as s, D as t, Y as u, P as v, Z as w, ee as x, re as y, ne as z, j as A, R as B, x as C, ue as D, B as E, te as F, oe as G, ie as H, le as I, de as J, fe as K };
